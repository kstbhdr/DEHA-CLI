...
exports.createShoppingCommand = createShoppingCommand;
var commander_1 = require("commander");
var shopping_service_1 = require("../services/shopping-service");
function createShoppingCommand() {
    var _this = this;
    var shoppingCommand = new commander_1.Command('shopping')
        .alias('shop')
        ...
        var searchOptions, shoppingService, results, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    searchOptions = {
                        query: query,
                        stores: options.stores ? options.stores.split(',').map(function (s) { return s.trim().toLowerCase(); }) : undefined,
                    ...
                    shoppingService = new shopping_service_1.ShoppingService();
                    return [4 /*yield*/, shoppingService.search(searchOptions)];
                case 1:
                    results = _a.sent();
                    return [4 /*yield*/, shoppingService.displayResults(results)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, shoppingService.close()];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ Hata:', error_1 instanceof Error ? error_1.message : 'Bilinmeyen hata');
                    process.exit(1);
                    return [3 /*break*/, 5];
