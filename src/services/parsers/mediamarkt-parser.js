...
exports.MediamarktParser = void 0;
var base_parser_1 = require("./base-parser");
var MediamarktParser = /** @class */ (function (_super) {
    __extends(MediamarktParser, _super);
    function MediamarktParser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'mediamarkt';
        _this.baseUrl = 'https://www.mediamarkt.com.tr';
        _this.searchPath = '/search?query=';
        return _this;
    }
    MediamarktParser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    MediamarktParser.prototype.parseProductList = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[Mediamarkt] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[Mediamarkt] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
    ...
    return MediamarktParser;
}(base_parser_1.BaseParser));
exports.MediamarktParser = MediamarktParser;
