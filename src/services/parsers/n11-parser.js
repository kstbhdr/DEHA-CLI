...
exports.N11Parser = void 0;
var base_parser_1 = require("./base-parser");
var N11Parser = /** @class */ (function (_super) {
    __extends(N11Parser, _super);
    function N11Parser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'n11';
        _this.baseUrl = 'https://www.n11.com';
        _this.searchPath = '/ara?q=';
        return _this;
    }
    N11Parser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    N11Parser.prototype.parseProductList = function (page) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, page.waitForSelector('[class*="product-card"], [class*="card"]', { timeout: 10000 })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, page.$$('[class*="product-card"], [class*="card"]')];
                    case 3:
                        items = _a.sent();
                        _i = 0, items_1 = items;
                        _a.label = 4;
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[N11] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[N11] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
