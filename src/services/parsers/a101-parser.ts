...
export class A101Parser extends BaseParser {
  protected storeName = 'a101';
  protected baseUrl = 'https://www.a101.com.tr';
    ...
    try {
      ...
      for (const item of items) {
        try {
          ...
          console.error(`[A101] Ürün parse hatası:`, itemError);
          continue;
        }
      }
    } catch (error) {
      console.error(`[A101] Liste parse hatası:`, error);
    }
