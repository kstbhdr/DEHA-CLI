...
export class CimriParser extends BaseParser {
  protected storeName = 'cimri';
  protected baseUrl = 'https://www.cimri.com';
    ...
    try {
      ...
      for (const item of items) {
        try {
          ...
          console.error(`[Cimri] Ürün parse hatası:`, itemError);
          continue;
        }
      }
    } catch (error) {
      console.error(`[Cimri] Liste parse hatası:`, error);
    }
