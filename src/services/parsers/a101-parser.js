...
exports.A101Parser = void 0;
var base_parser_1 = require("./base-parser");
var A101Parser = /** @class */ (function (_super) {
    __extends(A101Parser, _super);
    function A101Parser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'a101';
        _this.baseUrl = 'https://www.a101.com.tr';
        _this.searchPath = '/arama?q=';
        return _this;
    }
    A101Parser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    A101Parser.prototype.parseProductList = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[A101] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[A101] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
