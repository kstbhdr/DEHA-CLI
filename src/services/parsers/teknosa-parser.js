...
exports.TeknosaParser = void 0;
var base_parser_1 = require("./base-parser");
var TeknosaParser = /** @class */ (function (_super) {
    __extends(TeknosaParser, _super);
    function TeknosaParser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'teknosa';
        _this.baseUrl = 'https://www.teknosa.com';
        _this.searchPath = '/search?q=';
        return _this;
    }
    TeknosaParser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    TeknosaParser.prototype.parseProductList = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[Teknosa] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[Teknosa] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
    ...
    return TeknosaParser;
}(base_parser_1.BaseParser));
exports.TeknosaParser = TeknosaParser;
