...
exports.AkakceParser = void 0;
var base_parser_1 = require("./base-parser");
var AkakceParser = /** @class */ (function (_super) {
    __extends(AkakceParser, _super);
    function AkakceParser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'akakce';
        _this.baseUrl = 'https://www.akakce.com';
        _this.searchPath = '/arama/?q=';
        return _this;
    }
    AkakceParser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    AkakceParser.prototype.parseProductList = function (page) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, page.waitForSelector('[class*="product"], [class*="list-item"]', { timeout: 10000 })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, page.$$('[class*="product"], [class*="list-item"]')];
                    case 3:
                        items = _a.sent();
                        _i = 0, items_1 = items;
                        _a.label = 4;
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[Akakce] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[Akakce] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
...
exports.AkakceParser = AkakceParser;
