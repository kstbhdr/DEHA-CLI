...
export class MediamarktParser extends BaseParser {
  protected storeName = 'mediamarkt';
  protected baseUrl = 'https://www.mediamarkt.com.tr';
  protected searchPath = '/search?query=';
    ...
    try {
      ...
      for (const item of items) {
        try {
          ...
          console.error(`[Mediamarkt] Ürün parse hatası:`, itemError);
          continue;
        }
      }
    } catch (error) {
      console.error(`[Mediamarkt] Liste parse hatası:`, error);
    }
