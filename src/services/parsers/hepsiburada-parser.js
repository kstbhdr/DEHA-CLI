...
exports.HepsiburadaParser = void 0;
var base_parser_1 = require("./base-parser");
var HepsiburadaParser = /** @class */ (function (_super) {
    __extends(HepsiburadaParser, _super);
    function HepsiburadaParser() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.storeName = 'hepsiburada';
        _this.baseUrl = 'https://www.hepsiburada.com';
        _this.searchPath = '/ara?q=';
        return _this;
    }
    HepsiburadaParser.prototype.getSearchUrl = function (query) {
        return "".concat(this.baseUrl).concat(this.searchPath).concat(encodeURIComponent(query));
    };
    HepsiburadaParser.prototype.parseProductList = function (page) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, page.waitForSelector('[class*="product-card"], [class*="productItem"]', { timeout: 10000 })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, page.$$('[class*="product-card"], [class*="productItem"]')];
                    case 3:
                        items = _a.sent();
                        _i = 0, items_1 = items;
                        _a.label = 4;
                    ...
                    case 10:
                        itemError_1 = _a.sent();
                        console.error("[Hepsiburada] \u00DCr\u00FCn parse hatas\u0131:", itemError_1);
                        return [3 /*break*/, 11];
                    case 11:
                        _i++;
                        return [3 /*break*/, 4];
                    ...
                    case 13:
                        error_1 = _a.sent();
                        console.error("[Hepsiburada] Liste parse hatas\u0131:", error_1);
                        return [3 /*break*/, 14];
    ...
    return HepsiburadaParser;
}(base_parser_1.BaseParser));
exports.HepsiburadaParser = HepsiburadaParser;
